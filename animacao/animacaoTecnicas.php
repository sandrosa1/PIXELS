            ...
            <div class="row">
                <div class="col-md-12 tecnicasAni">
                    <aside>
                        ...
                        <p class=" text-justify">Flash é um tipo de animação originalmente criadas no programa
                            Macromedia
                            Flash e tinham suporte basicamente à animação 2D vetorial. Já atualmente, podem ser criadas
                            no
                            Adobe Flash, que tem suporte inclusive à animação 3D. As animações flash são distribuídas em
                            formato .fla como raiz e .swf como animação exportada. As animações flash criadas nas
                            versões
                            mais atuais, têm suporte à interatividade através de scripts elaborados com a linguagem
                            Action
                            Script. A maioria das animações em Flash são distribuídas na web e são muito úteis até os
                            dias
                            de hoje.</p>
                    </aside>
                    <aside>
                        ...
                        <p class=" text-justify">Cel shading, também conhecido como toon shading é um conjunto de
                            técnicas
                            empregadas na renderização de imagens 3D de modo que o resultado final se assemelhe ao de
                            desenhos em 2D.A forma mais simples de se obter esse efeito é empregando contornos escuros
                            nos
                    ...
                    <aside>
                            ...
                            <p class=" text-justify">Captura de movimento, ou mocap, é um termo usado para descrever o
                                processo
                                de gravação de movimento e transposição do movimento em um modelo digital. Inicialmente
                                inventado na Escócia, a técnica é usada em militarismo, entretenimento, esportes e
                                aplicações
                                médicas. Em produções cinematográficas, o termo refere-se a gravar ações de atores
                                humanos e
                                usar tais informações para animar modelos de personagens virtuais em animação 3D. Quando
                                se
                                inclui a face, os dedos ou quando se captura expressões sutis, é frequentemente referido
                                como
                                captura de performance.</p>
                    </aside>
                    <aside>
                        <img class="img-fluid  align-items-center" id="machinima"
                            alt="Apresentação do primeiro jogo feito em Machinima"
                        ...
                        <p class=" text-justify">Machinima, termo criado pela junção das palavras inglesas machine
                            (máquina), animation (animação) e cinema, é tanto uma técnica de produção fílmica quanto o
                            filme
                            ...
                            usam
                            softwares em 3D profissionais. Como gênero fílmico, o termo refere a filmes criados
                            utilizando
                            esses jogos e ambientes virtuais interativos em tempo real. Usualmente, machinimas são
                            produzidos usando ferramentas e recursos disponíveis em um jogo. O primeiro filme
                            reconhecido
                            como machinima foi feito no jogo Quake. Lançado em 1996 pelo clã The Rangers, Diary of a
                            Camper
                            é um curta-metragem com cerca de 1 minuto. Na época, o termo machinima ainda não existia e
                            os
                            filmes feitos em Quake eram chamados apenas de "filmes de Quake". No início da década de
                            2000, o
                            ...
                            machinima foi a americana Rooster Teeth, que após criar Red vs. Blue em 2004 a partir de
                            Halo:
                            Combat Evolved, ganhou a bênção da produtora Bungie para usar os componentes do jogo sem
                            pagar
                            por isso, e fez parcerias com a distribuidora Microsoft, com episódios especiais vendidos na
                            Xbox Live e vídeos para promover sequências de Halo. A Rooster Teeth foi até patrocinada
                            pela
                            Electronic Arts para criar uma série baseada em The Sims 2, The Strangerhood.</p>
                    </aside>
                    <aside>
                        <img class="img-fluid  align-items-center" id="limitada"
                            alt="Imagen do Mr. Magoo personagem de desenho animado"
                            src="../imagem/animacao/animacaoMisterMagoo.webp" />
                        <h4 class=" text-center animacaoh1 ">Animação Limitada</h4>
                        <p class=" text-justify">Animação limitada é uma técnica de produção de desenhos animados onde
                            os
                            ...
                            maior agilidade, economizando o tempo e o custo da produção de uma série de desenho animado.
                            A
                            animação limitada é uma técnica oposta à animação total (utilizada nos desenhos animados de
                            Walt
                            Disney). Essa técnica foi popularizada nos desenhos produzidos pelo estúdio United
                            Productions
                    ...
                    <aside>
                        ...
                        <p class=" text-justify">Pixilation (de pixilated ) é um stop motion técnica onde atores ao vivo
                            são
                            usados como um assunto frame-by-frame em uma animação filme, fazendo-se passar repetidamente
                            enquanto um ou mais quadros é tomada e mudando representar um pouco antes do próximo quadro
                            ou
                            quadros. O ator se torna uma espécie de viver stop motion fantoche . Esta técnica é muitas
                            vezes
                            usado como uma forma de misturar atores ao vivo com os animados em um filme, como em The
                            Thumb
                            Segredo Aventuras de Tom pelas Bolex Irmãos . Os primeiros exemplos desta técnica são El
                            Hotel
                    ...
                    <aside>
                        ...
                        <p class=" text-justify">Claymation ou clay animation é uma técnica de animação baseada em
                            modelos
                            de plasticina (massa de modelar), barro ou material similar. Clay animation Na clay
                            animation,
                            que é uma das inúmeras formas de stop motion, cada objeto é esculpido em plasticina (massa
                            de
