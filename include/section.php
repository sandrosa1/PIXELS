<div class="animacaoGaleria">
    ...
    <div class=" row imagensGaleria">
        ...
        <div class=" col-lg-3 galeria ">
            ...
            {
                echo '../servicos/normas.php';
            }
            ?>
            " style="text-decoration:none;color:black;"><img src="../imagem/norma800.png"
                    alt="Foto da pagina de normas " style="width:90%"><h5 class="card-title  animacaoh1 ">Normas de utilização</h5>
                <p class="text-left">Atenção leia nossas normas de utilização para maior segurança <b>Saiba Mais...</b>
                </p>
            </div>
            <div class=" col-lg-3 galeria ">
            <!--Desenho Vetorial-->
            <a href="<?php if($page == 'pixel')
            {
                echo 'pixel.php';
            }else
            {
                echo '../pixel/pixel.php';
            }
            ?>
            " style="text-decoration:none;color:black;"><img src="../imagem/pixelart-principal882x296.png"
                    alt="Logo tipo doa pagina pixel art" style="width:90%">
                <h5 class="card-title  animacaoh1">A arte do ponto a ponto</h5>
