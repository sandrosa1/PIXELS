    ...
    <article>
        ...
        <div class="row mx-3 my-3 justify-content-center">
            <div class="col-sm-12 col-md-12 col-lg-6">
                <p class="text-justify lead ilustSobre">A arte digital deu seus primeiros sinais de vida logo depois da Segunda Guerra Mundial e ganhou força nos anos 60, quando pesquisas relacionadas a algoritmos e computadores chamaram a atenção da ciência. </p>
                <p class="text-justify lead">Os pioneiros desta arte são justamente engenheiros e cientistas como A. Michael Noll, que usou computadores em 1962 para criar imagens através de padrões e algoritmos matemáticos.</p>
            </div>
            <div class="col-sm-12 col-md-12 col-lg-6">
        ...
        <div class="row mx-3 my-3 justify-content-center">
            <div class="col-sm-12 col-md-12 col-lg-12">
                <p class="text-justify lead">Em 2010, nasceu o Instagram, uma ferramenta e rede social que se tornou ponto de encontro e portfólio para os mais diversos artistas e estilos. É, hoje, um imenso repositório de arte digital com alcance global.</p>
            </div>
        </div>
        <div class="row mx-3 my-3 justify-content-center">
            <div class="col-sm-12 col-md-12 col-lg-6">
