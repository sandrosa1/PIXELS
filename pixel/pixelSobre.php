    ...
    <article id="pixel-sobre">
        ...
        <div class="row justify-content-center no-margin">
            <div class="col-sm-12 col-md-10 col-lg-10 text-center">
                ...
                <p class="text-justify">O pixel está limitado ao sistema de cores que a máquina utiliza, como o RGB, que utiliza uma combinação de cores vermelho, verde e azul conseguindo exibir uma paleta de mais de 10mil cores. A quantidade de cores, varia de acordo com a evolução do hardware.</p>
        ...
        <div class="row justify-content-center no-margin my-4">
            <div class="col-sm-12 col-md-10 col-lg-10 text-justify">
            ...
            <div class="col-sm-12 col-md-10 col-lg-10 card-deck">
...
<div class="row justify-content-center no-margin my-4">
    <div class="col-sm-12 col-md-10 col-lg-10 text-center">
        ...
        <img src="../imagem/pixel/pixelforest.webp" alt="Exposição Pixel Forest com luzes pendentes" class="float-sm-none float-md-right img-fluid rounded ml-3" />
