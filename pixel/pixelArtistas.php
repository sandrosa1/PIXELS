    ...
    <article class="row justify-content-center no-margin mt-4">
        <div class="col-sm-12 col-md-10 col-lg-9 ">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="artistas-tab" data-toggle="tab" href="#artistas" role="tab" aria-controls="artistas" aria-selected="true">Conheça alguns artistas</a>
                </li>
                <li class="nav-item">
            ...
            <div class="tab-content mt-5" id="myTabContent">
                ...
                <div class="tab-pane fade text-center" id="glauber" role="tabpanel" aria-labelledby="glauber-tab">
                    <img src="../imagem/pixel/glauber-300.webp" class="float-sm-none float-md-left mr-3" alt="Foto de rosto do artista de pixel art Glauber Kotaki">
