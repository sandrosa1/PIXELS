...
<div class="container-fluid" id="inicio">
    ...
    <div class="row no-margin justify-content-center mt-5 mb-5">
        <div class="card-deck max-width ">
            ...
            <div class="card dev4">
                <img class="card-img-top" src="../imagem/quem_somos/user.png" alt="Imagem de perfil do Alexandre">
                <div class="card-body">
            ...
            <div class="card dev5">
                ...
                <div class="card-body">
                    ...
                    <p class="text-center mt-1"> UI/UX Designer, Dev Front-End</p>
                    <hr>
                ...
                <div class="card-footer">
                    <small class="text-muted">
                        <p><b>Desenvolvimento</b>: <a href="normas.php" target="_blank">Normas de Utilização</a>, <a href="quemSomos.php" target="_blank">Quem Somos</a>, <a href="../pixel/pixel.php" target="_blank">Pixel Art</a>, <a href="../pixel/pixelSobre.php" target="_blank">Pixel Art - Sobre</a>, <a href="../pixel/pixelArtistas.php" target="_blank">Pixel Art - Artistas</a>, <a href="../pixel/pixelGaleria.php" target="_blank">Pixel Art - Galeria</a>
                    </small>
                </div>
            </div>
        </div>
