  ...
  <div class="pb-4 row no-margin">
    <div class="d-flex flex-wrap quem-somos">
      ...
      <div class="col-sm-12 col-md-12 col-lg-4 d-flex 
           mb-3">
        <div class="text-center dev0 p-2 rounded">
          <img class="float-sm-none float-md-left float-lg-none img-fluid mx-auto px-2 rounded-circle " height="280" width="280" src="../imagem/logos/logo500.png" alt="Logo do Pixel">
          <div class="p-2">
      ...
      <div class="col-sm-12 col-md-12 col-lg-4 d-flex 
           mb-3">
        <div class="text-center dev3 p-2 rounded">
      ...
      <div class="col-sm-12 col-md-12 col-lg-4 d-flex 
        ...
        <div class="text-center dev5 p-2 rounded">
          ...
          <hr>
          <div class="stick-bottom px-2 justify-content-left text-justify">
            <small class="text-muted"><b>Desenvolvimento</b>: <a href="normas.php" target="_blank">Index</a>,
              <a href="normas.php" target="_blank">Carreira</a>, <a href="normas.php" target="_blank">Normas</a>, <a href="quemSomos.php" target="_blank">Quem Somos</a>, <a href="../pixel/pixel.php" target="_blank">Pixel Art</a>, <a href="../pixel/pixelSobre.php" target="_blank">Pixel Art - Sobre</a>, <a href="../pixel/pixelArtistas.php" target="_blank">Pixel Art - Principais nomes</a>, <a href="../pixel/pixelGaleria.php" target="_blank">Pixel Art - Galeria</a>
            </small>
          </div>
        </div>
      </div>
