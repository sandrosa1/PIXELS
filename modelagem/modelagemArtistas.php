    ...
    <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    já participou de diversos projetos pra publicidade, games e animação. Além disso, ele criou o curta-metragem One More Beer, que ficou incrível e você deve assistir! </p>
                    <p class=" text-justify">
                    O artista basileiro com lindos trabalhos. Ele começou sua carreira entre 2005 e 2006 
                    (o próprio Conti diz não lembrar com certeza qual é o ano correto hahaha), com um pouco de influência do pai, que já trabalhava com 3D em sua empresa de computação gráfica. </p>
                    <p class=" text-justify">
                    Autodidata, Conti chegou a cursar design mas não o concluiu pois decidiu dedicar-se aos seus estudos de 3D e animação. Em uma entrevista ao site Cutedrop, Pedro conta que foi graças a sua dedicação que conseguiu seu 
                    primeiro emprego na área já em 2006 e um ano depois, foi convidado a trabalhar na Seagulls Fly, uma das maiores empresas brasileiras de animação. </p>
                    <p class=" text-justify">
                    O artista também já foi sócio da TechnoImage e freelancer de grandes empresas em longas-metragens. Seu trabalho mais recentes é na animação Moana, do Walt Disney Animation Studios. 
                    Atualmente Conti está trabalhando como freela em pré-produções de jogos, filmes e séries. </p>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <p class=" text-justify">Letícia Reinaldo trabalha no excelente estúdio ZQuatro e está desenvolvendo vários personagens no Blender. 
                        O mais interessante é o fato do estúdio utilizar também o Blender em suas produções, além de produzir trabalhos fantásticos.</p>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    E o cara ainda está trabalhando em Star Wars VII e na sequência de Avatar. Está de parabéns! </p>
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    Game designers, fiquem de olho no cara! </p>
